...
- **CodeBlock** - Display code in multiple languages (Julia, Python, R, C++, C, Java, JavaScript, Rust, SQL, PostgreSQL) with syntax highlighting; only Julia code can be executed
