using JSPlots, DataFrames, Dates, Statistics, Random, StableRNGs, StatsBase
...
manifest_entry = ManifestEntry(path="..", html_filename="graph_examples.html",
                               description="Graph Examples", date=today(),
